                                ...
                                <div class="rcorners" style="margin-top: 20px">
                                    <div class="verticalLine">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control make_user recorder" name="nombre" id="nombre" value="{{$product->nombre}}" required autofocus/>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 5px">
                                            <label for="sku" class="col-sm-3 control-label">{{trans('admin.sku')}}<span style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control make_user recorder" name="sku" id="sku" value="{{$product->sku}}" required autofocus/>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 5px">
                                            <label for="marca" class="col-sm-3 control-label">{{trans('admin.brand')}}<span style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control make_user recorder" name="marca" id="marca" value="{{$product->marca}}" required autofocus/>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 5px">
                                            <label for="costo" class="col-sm-3 control-label">{{trans('admin.price')}}<span style="color: red">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control make_user recorder" name="costo" id="costo" value="{{$product->costo}}" required autofocus/>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 5px">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="tipo" name="tipo" class="form-control select2 recorder selector" >
                                                    @foreach($tipo as $key=>$val)
                                                        <option value="{{ $key }}" @if($key == $product->getProductType()) selected @endif>{{ $val }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="verticalLine">
                                        <div class="tv product_optional" @if($product->getProductType() != 'tv') hidden @endif>
                                                ...
                                                <div class="col-sm-9">
                                                    <select id="tipo_pantalla" name="tipo_pantalla" class="form-control select2 recorder" >
                                                        ...
                                                        @foreach($tipo_pantalla as $key=>$val)
                                                            <option value="{{ $key }}" @if($product->getChildData() != null and $val == $product->getChildData()->tipo_pantalla) selected @endif>{{ $val }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-top: 5px">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="number" class="form-control make_user recorder" name="tamano_pantalla" id="tamano_pantalla" value="{{$product->getChildData() != null?$product->getChildData()->tamano_pantalla:''}}" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="laptop product_optional" @if($product->getProductType() != 'laptop') hidden @endif>
                                                ...
                                                <div class="col-sm-9">
                                                    <select id="procesador" name="procesador" class="form-control select2 recorder" >
                                                        ...
                                                        @foreach($procesador as $key=>$val)
                                                            <option value="{{ $key }}" @if($product->getChildData() != null and $val == $product->getChildData()->procesador) selected @endif>{{ $val }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-top: 5px">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="number" class="form-control make_user recorder" name="ram" id="ram" value="{{$product->getChildData() != null?$product->getChildData()->ram:''}}" />
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-sm-9">
                                                    <select id="material" name="material" class="form-control select2 recorder" >
                                                        ...
                                                        @foreach($material as $key=>$val)
                                                            <option value="{{ $key }}" @if($product->getChildData() != null and $val == $product->getChildData()->material) selected @endif>{{ $val }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
